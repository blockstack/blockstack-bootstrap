...
1. From the root `/bootstrap` directory, run `bundle exec jekyll serve` in the command line to serve up the documentation site with style guide.
1. Open <http://localhost:4000> in your browser to view the documentation site.
